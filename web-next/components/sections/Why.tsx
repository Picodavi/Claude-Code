      ...
      <div className="mx-auto max-w-6xl">
        ...
        <div className="mt-12 grid gap-5 sm:grid-cols-2 lg:grid-cols-3">
          {WHY.map((w) => (
            <div
              key={w}
              className="rounded-2xl border border-border bg-bg/85 p-7 shadow-sm backdrop-blur transition-all duration-300 hover:-translate-y-2 hover:border-gold/60 hover:shadow-[0_24px_50px_-20px_rgba(124,71,18,0.35)]"
            >
